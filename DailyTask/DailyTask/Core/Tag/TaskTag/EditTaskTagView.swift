...
class EditTaskTagView: UIViewController, UISheetPresentationControllerDelegate, UITextFieldDelegate, UITextViewDelegate {
    
    var viewModel: EditTaskTagViewModel?
    ...
    @objc func saveAndClose() {
        viewModel?.editTagTask(id: UUID(), name: textField.text ?? "", red: 0, green: 0, blue: 0)
        self.dismiss(animated: true, completion: nil)
